...
class DetailsPanelNode extends React.Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (
      this.state.region !== nextProps.region ||
      this.state.node.getName() !== nextProps.node.getName()
    ) {
      ...
      <div className="details-panel">
        <div className="subsection">
          <div className="details-panel-title">
            ...
            <span
              ...
              onClick={this.props.zoomCallback}
            />
          </div>
          <div
        ...
        {node && !node.isEntryNode() ? (
          <DetailsSubpanel
            ...
            badge={node.incomingConnections.length}
          >
            <ConnectionList
              key={node.getName()}
              connections={node.incomingConnections}
              direction="incoming"
              nodeClicked={clickedNode => this.props.nodeClicked(clickedNode)}
            />
          </DetailsSubpanel>
        ) : (
          undefined
        ...
        <DetailsSubpanel
          ...
          badge={node.outgoingConnections.length}
        >
          <ConnectionList
            key={node.getName()}
